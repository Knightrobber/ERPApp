  ...
  export default class SetHolidays extends Component{
    ...
    <Text style={styles.TextStyle}>Holidays</Text>
        ...
        <SafeAreaView style={styles.datesContainerTop}>
          ...
          <DatePicker style={{ backgroundColor:'#fff', borderRadius: 5}} borderRadius={10} date={this.state.dateHoliday} format="YYYY-MM-DD" onDateChange={(date) => {this.setState({dateHoliday: date})}}  mode="date" placeholder="select date" />
        <TouchableHighlight style={styles.SubmitButtonStyle} activeOpacity = { 0.5 } onPress={()=>{this.setHoliday()}}>
        <LinearGradient colors={['#36D6BD','#007E7B']} start={{ x:0, y:1}} style={ styles.Linear_G }>
          ...
          <SafeAreaView style={styles.setholidays}>
          <DatePicker style={{ backgroundColor:'#fff', borderRadius: 5}} date={this.state.holidayDelete} format="YYYY-MM-DD" onDateChange={(date) => {this.setState({holidayDelete: date})}}  mode="date" placeholder="select date" />

            <TouchableHighlight style={styles.SubmitButtonStyle} activeOpacity = { 0.5 } onPress={()=>{this.deleteHoliday()}}>
        <LinearGradient colors={['#36D6BD','#007E7B']} start={{ x:0, y:1}} style={ styles.Linear_G }>
      ...
      <Text style={styles.TextStyle}>Semester Details</Text>
          ...
          <SafeAreaView style={styles.datesContainerBottom}>
            ...
            <DatePicker style={{ backgroundColor:'#fff', borderRadius: 5}} date={this.state.dateBegin} format="YYYY-MM-DD" onDateChange={(date) => {this.setState({dateBegin: date})}}  mode="date" placeholder="select date" />

            </SafeAreaView>

            <SafeAreaView style={styles.setsem}>
              <Text style={styles.TextStyleSemDates}>Set Midsem</Text>
            <DatePicker style={{ backgroundColor:'#fff', borderRadius: 5}} date={this.state.dateEndMid} format="YYYY-MM-DD" onDateChange={(date) => {this.setState({dateEndMid: date})}}  mode="date" placeholder="select date" />

            </SafeAreaView>

            <SafeAreaView style={styles.setsem}>
              <Text style={styles.TextStyleSemDates}>Set Endsem</Text>
            <DatePicker style={{ backgroundColor:'#fff', borderRadius: 5}} date={this.state.dateEndEnd} format="YYYY-MM-DD" onDateChange={(date) => {this.setState({dateEndEnd: date})}}  mode="date" placeholder="select date" />

            </SafeAreaView>
            <TouchableHighlight style={styles.SetButtonStyle} activeOpacity = { 0.5 } onPress={()=>{this.setSemDates()}}>
            <LinearGradient colors={['#36D6BD','#007E7B']} start={{ x:0, y:1}} style={ styles.Linear_G }>
